...
module "vm_extension_monitoring_agent" {
  ...
  source = "git::https://github.com/aztfmod/terraform-azurerm-caf.git//modules/compute/virtual_machine_extensions?ref=vw-combined-backup-october-2022"
...
module "vm_extension_aadlogin" {
  ...
  #source = "git::https://github.com/aztfmod/terraform-azurerm-caf.git//modules/compute/virtual_machine_extensions?ref=vw-combined-backup-october-2022"
  source = "git::https://github.com/VolkerWessels/terraform-azurerm-caf.git//modules/compute/virtual_machine_extensions?ref=vw-combined-backup-october-2022"
